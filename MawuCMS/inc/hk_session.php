...
{
    $msg = '<div class="alert alert-danger alert-dismissible" role="alert"><div class="alert-text">Tu ne peux pas ou plus accéder ici.</div></div><meta http-equiv="refresh" content="5; url=https://godhotel.biz">';
}
